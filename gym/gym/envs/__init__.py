...
register(
    id='ddrp_basic-v0',
    entry_point='gym.envs.my_collection:ddrpBasicEnv',
)

register(
    id='ddrp_large-v0',
    entry_point='gym.envs.my_collection:ddrpLargeEnv',
    max_episode_steps=40
)

register(
    id='ddrp_massive-v0',
    entry_point='gym.envs.my_collection:ddrpMassiveEnv',
    max_episode_steps=10
)

register(
    id='ddrp_options-v0',
    entry_point='gym.envs.my_collection:ddrpOptionsEnv',
